...
-- 5. Do subscribed customer spend more? compare average spend and total revenew between subscriber and non-subscriber
SELECT 
    subscription_status,
...
-- 7. segment customers into new, returning, and loyal based on thier total number of previous purchase and show the count of each segment.
